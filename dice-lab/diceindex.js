...
iRollDice = prompt("How many times would you like to play?",4);
function rollDice() {
...
function whoWon() {
    ...
    scorebanner = "Your current balance is " + score + " dollars" 
    document.querySelector("h3").innerHTML = banner + "<br>" + outcome + "<br>" + scorebanner;
